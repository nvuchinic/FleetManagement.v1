...
create table requests_notification (
  id                        bigint not null,
  constraint pk_requests_notification primary key (id))
;
...
create sequence requests_notification_seq;
...
alter table requests add constraint fk_requests_notification_18 foreign key (notification_id) references requests_notification (id) on delete restrict on update restrict;
create index ix_requests_notification_18 on requests (notification_id);
...
drop sequence if exists requests_notification_seq;
