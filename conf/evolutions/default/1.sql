...
alter table vehicle add constraint fk_vehicle_owner_7 foreign key (owner_id) references owner (id);
create index ix_vehicle_owner_7 on vehicle (owner_id);
alter table vehicle add constraint fk_vehicle_fleet_8 foreign key (fleet_id) references fleet (id);
create index ix_vehicle_fleet_8 on vehicle (fleet_id);
alter table vehicle add constraint fk_vehicle_typev_9 foreign key (typev_id) references type (id);
create index ix_vehicle_typev_9 on vehicle (typev_id);
alter table vehicle add constraint fk_vehicle_travelOrder_10 foreign key (travel_order_id) references travel_order (id);
create index ix_vehicle_travelOrder_10 on vehicle (travel_order_id);
alter table vehicle add constraint fk_vehicle_prev_11 foreign key (prev_id) references vehicle (id);
create index ix_vehicle_prev_11 on vehicle (prev_id);
alter table vehicle add constraint fk_vehicle_next_12 foreign key (next_id) references vehicle (id);
create index ix_vehicle_next_12 on vehicle (next_id);
alter table vehicle add constraint fk_vehicle_vRegistration_13 foreign key (v_registration_id) references vehicle_registration (id);
create index ix_vehicle_vRegistration_13 on vehicle (v_registration_id);
alter table vehicle_registration add constraint fk_vehicle_registration_vehic_14 foreign key (vehicle_id) references vehicle (id);
