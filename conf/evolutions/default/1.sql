...
alter table vehicle_registration add constraint fk_vehicle_registration_registrationHolder_22 foreign key (registration_holder_id) references owner (id) on delete restrict on update restrict;
create index ix_vehicle_registration_registrationHolder_22 on vehicle_registration (registration_holder_id);
