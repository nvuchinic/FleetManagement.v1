...
public class VehicleInspection extends Model{
	...
	public VehicleInspection(Date inspectDate,String vehicleDocument, String safety, String body, String tiresWheels,
			String steeringSuspension, String brakes, String lightningElSystem, String glass, 
			String exhaustSystem, String emission, String obd, String fuelSystem, String addNotes,  Vehicle vehicle) {
		...
		this.brakes=brakes;this.lightningElSystem=lightningElSystem;
		this.glass=glass;
	...
	public static VehicleInspection saveToDB(Date inspectDate, String vehicleDocument, String safety, String body,
			String tiresWheels,String steeringSuspension, String brakes, String lightningElSystem, 
			String glass, String exhaustSystem, String emission, String obd, String fuelSystem, 
			String addNotes,  Vehicle vehicle) {
		VehicleInspection vi= new VehicleInspection(inspectDate,vehicleDocument, safety, body, 
		tiresWheels, steeringSuspension, brakes, lightningElSystem,
		glass, exhaustSystem, emission, obd, fuelSystem, addNotes, vehicle);
		vi.save();
		return vi;
	}
...
//
	 ...
	 * 
	 * @param id-ID of VehicleInspection object
