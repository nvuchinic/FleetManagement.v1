...
public class Driver extends Model {
	 ...
	 */
	public static long createDriver(String name, String surname,
			String phoneNumber, String adress, String description, Date dob) {
		Driver driver = new Driver(name, surname, phoneNumber, adress,
				description, dob);
		driver.save();
		return driver.id;
	...
	public static Long saveToDB(String name, String surname,
			String phoneNumber, String adress, String description, Date dob) {
		Driver driver = new Driver(name, surname, phoneNumber, adress,
				description, dob);
		driver.save();
	...
	public static Driver saveToDb(String name, String surname,
			String phoneNumber, String adress, String description, Date dob) {
		Driver driver = new Driver(name, surname, phoneNumber, adress,
				description, dob);
		driver.save();
