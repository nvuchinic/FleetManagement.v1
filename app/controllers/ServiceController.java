...
public class ServiceController extends Controller {
	...
	/**
	 * Finds Service object based on passed parameter, then removes it from
	 * database
	 * 
	 * @param id
	 *            - Service id (long)
	...
	/**
	 * Renders the view of a Service object. Method receives the id of the
	 * service and finds the vehicle by id and send's the Service object to the
	 * view.
	 * 
	 * @param id
	 *            long
	...
	/**
	 * Method receives an id, finds the specific Service object, then takes data
	 * from submitted form and updates Service object with them
	 * 
	 * @param id
	 *            of Service object
	...
	/**
	 * First checks if the service adding form has errors. Creates a new Service
	 * object or renders the view again if any error occurs.
	 * 
	 * @return
