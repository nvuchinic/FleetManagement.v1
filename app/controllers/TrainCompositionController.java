...
public class TrainCompositionController extends Controller {
	...
	static Form<TrainComposition> trainCmpForm = Form
			.form(TrainComposition.class);
	...
	public Result attachWagon(long tcId) {
		...
		Form<TrainComposition> attachWagonForm = Form.form(
				TrainComposition.class).bindFromRequest();
		String wagonName;
		try {
			...
			Logger.error("Creating train composition error: " + e.getMessage(),
					e);
			System.out
					.println("ERROR ATTACHING WAGON////////////////////////////"
							+ e.getMessage());
	...
	public Result editTrainComposition(long id) {
		...
		Form<TrainComposition> form = Form.form(TrainComposition.class)
				.bindFromRequest();
		TrainComposition tc = TrainComposition.findById(id);
		try {
	...
	public Result listTrainCompositions() {
		// List<TrainComposition> alltrainComps=new
		// ArrayList<TrainComposition>();
